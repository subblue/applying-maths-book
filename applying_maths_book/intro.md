...
Currently the equation numbering is not being rendered properly. For reasons that are not clear the markdown  \tag{..} is being ingored. Hopefully this will be corrected infuture versions of Jupyter-book.