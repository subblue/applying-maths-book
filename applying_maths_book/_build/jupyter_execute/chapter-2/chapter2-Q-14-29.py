...
# 
# **Strategy** Convert the equations into cosine /sine form (see eqn. 16) and calculate the intensity. Recall that the scattering factor is squared to find the intensity.
