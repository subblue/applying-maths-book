...
# >(1) Substitute for any partial derivatives using (in this example) the ideal gas law to
...
# the equation of a straight line; $\displaystyle T= \frac{T_1-T_0}{p_1-p_0}(p-p_0)+T_0$ with gradient $\displaystyle \frac{dT}{dp}=\frac{T_1-T_0}{p_1-p_0}=m$ and substituting this and $T$ into the equation for $S_T$ and integrating gives
# 
