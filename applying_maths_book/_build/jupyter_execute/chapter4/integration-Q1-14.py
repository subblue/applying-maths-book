...
# $f = 2\sin(\omega_0 t)\boldsymbol{ i} + cos(\omega_0 t)\boldsymbol{j} + t\boldsymbol{k}$ .
# 
...
# 
# $$H_T^\mathrm{o}-H_{289}^\mathrm{o} =\int_{298}^T C_pdT \qquad \text{and}\qquad S_T^\mathrm{o}-S_{289}^\mathrm{o} =\int_{298}^T \frac{C_p}{T}dT$$
# 
...
# At the triple point $p$ = 36 torr and $T = 5.5 \mathrm{^{o}C},\, \Delta_{fus}H = +10.6 \,\mathrm{kJ\, mol^{-1}}$, $\Delta_{vap}H = +30.8 \,\mathrm{kJ \,mol^{-1}}, \rho (solid) = 0.891\, \mathrm{g \,cm^{-3}}, \rho(liquid) = 0.879\,\mathrm{ g \,cm^{-3}}$.
# 
...
# 
# $$q - q_0 = \frac{\gamma}{\gamma-1}p_0V_0\left( 1-\left(\frac{p}{p_0}\right)^{(\gamma -1)/\gamma }\right) $$
# 
...
# 
# $$u_s= \sqrt{\frac{2\gamma}{\gamma + 1}\frac{RT}{m} }$$
# 
