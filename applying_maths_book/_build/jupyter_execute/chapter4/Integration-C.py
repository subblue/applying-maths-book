...
# 
# Figure 11a. Left: The cardioid $r = a(1 + \cos(\theta))$ with $a = 1$ drawn in polar coordinates but with<br> 'normal axes' which are, however, not $x$ and $y$<br> but in angle and showing only $0$ and $\pi/2$ radians.Figure 11b. The same cardoid as in 11a but with polar axes.
# _________
# 
# 
...
# 
# Figure 11c. Left: A 'Peanut', $r = 1/4 + \sin^2(\theta + \pi/4)$. Figure 12. Right. Plot of $r = 2 \cos(\theta)$. The angle the curve makes with the<br> horizontal or polar axis, at the pole (origin) is $\pm \pi /2$.
# ______
# 
