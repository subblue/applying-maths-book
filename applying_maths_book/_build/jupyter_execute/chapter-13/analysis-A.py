...
# 
# #### Example (i) Estimate K$^+$ content of glass
...
# 
# #### Example (iii) Comparing columns yields in chromatography
...
# 
# #### Example (iv) Comparing fluorescence yields
...
# #### Example (viii) Vapour pressure continued
