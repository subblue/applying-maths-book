...
# 
# $$\displaystyle \sigma_m = \sigma/\sqrt{n}$$
# 
# This confirms that measurements get more precise with the square root of the number of measurements. If a new statistic $Z$ is defined as
# 
...
# 
# ### **(i) Comparing columns yields in chromatography**
...
# 
# ### **(ii) Comparing fluorescence yields**
