...
# 
# **Solution**. (a) The parameter $\mu =\lambda t =0.4\cdot 2$ taking the time unit as $100$ ns and $k=0$ for no event so $ p(k,\mu) = e^{-0.8} = 0.45 $. In (b) because the events are independent so probability of an event between time slot $2\to 3$ is the same as that of $0\to 1$, thus $p(k,\mu)= e^{-0.4}=0.67$.
# 
...
# 
# **Solution**. (a) Again taking the time unit as $100$ ns $\mu=4\cdot 0.5$ for the first photon ($k=1$) giving $p(k,\mu)=\mu e^{-\mu} = 2e^{-2} = 0.27$. (b) The probability of the total event is the product of the two, where each event is independent, there is one photon in the first period and $4$ more in the extra period. For the extra period, $\mu=4\cdot 2$ and the probability with $k=4$ is $p(k,\mu)=8^4e^{-8}/4!=0.057$ and combined is $0.0155$.
# 
...
# 
# ### **(vii) Weighting the Poisson data**
# 
