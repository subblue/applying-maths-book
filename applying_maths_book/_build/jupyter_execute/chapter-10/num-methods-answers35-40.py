...
# **Q 35 answer**  Use the shooting method algorithm described the text. The resulting curve is roughly U shaped crossing zero at $\approx 3/4$ and having a minimum at $\approx 3.4$. It is essential to modify the algorithm used to prevent division by zero such by adding a small term such as $\approx 10^{-10}$.
# 
# **Q36 answer** Using the code,with a maximum $x$ of 6, and an energy increment of 0.1, gives the results in table 4. A large value of $x$ is essential to get accurate eigenvalues. 
