...
# **Q8** In this problem, a differential equation is solved in two different ways but by three different numerical methods.
# 
...
# 
# >**(c)** Confirm that Python's or other language 'dsolve' procedure agrees with your calculation. 
# 
...
# 
# 
# **Q9** Calculate the scattering trajectories produced by a Coulomb potential and by a screened Coulomb or Yukawa potential, $U(r) = \alpha e^{-\beta r}/r$. Before doing the calculation describe what the scattering trajectories should look like. Consider the case when $\alpha$ is positive and negative.
# 
# **Q10** In a scattering experiment, the incoming atomic or molecular beam has a cylindrical symmetry and the elastically scattered beam retains this symmetry. The *differential cross section* $I(E_0, \chi)$ for scattering is defined as the number of particles entering a unit solid angle, in unit time, divided by the incident flux density. A solid angle, measured in steradians, is really an area in the sense that it is the angle subtended by circle drawn on the surface of a sphere. A sphere subtends a solid angle of $4\pi$ sterads, a hemisphere of $2\pi$ and so forth. The differential cross section is given by $\displaystyle I(E_0,\chi)=\frac{b}{\sin(\chi)}\bigg| \frac{db}{d\chi} \bigg|$. 
# 
# Calculate this for the hard sphere and Coulomb potentials.
# 
# **Q11** A football is thrown upwards from a height $h$ with initial velocity $v_0$; the friction slowing the ball is proportional to its velocity. The ball bounces elastically, when it reaches the ground. The equation of motion, found by balancing forces, is
# 
...
# 
# **Q12**  Re-calculate the last problem using the velocity Verlet algorithm.
