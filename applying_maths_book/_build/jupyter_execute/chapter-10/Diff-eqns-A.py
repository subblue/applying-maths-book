...
# 
# $$\displaystyle \frac{d[A]}{dt}=-k_1[A]. \quad  [A_0]=A_0  \tag{1} $$
# 
...
# 
# $$\displaystyle Xdx + Ydy=0  \tag{2}$$
# 
# which integrates to 
# 
# $$\displaystyle  \int Xdx+\int Ydy = c \tag{3}$$
# 
...
# 
# $$\displaystyle  \frac{dA}{dt}=-k_1A, \quad \frac{dA}{A}=-k_1t, \quad \int\frac{dA}{A}=-k_1\int dt, \quad \ln(A)=-k_1t+c $$ 
# 
...
# 
# $$\displaystyle \begin{align} G +h\nu &{\stackrel{k_a}{\longrightarrow}} S_1 \\ S_1 &{\stackrel{k_f}{\longrightarrow}} G+h\nu \\ S_1 &{\stackrel{k_S}{\longrightarrow}} T  \tag{4} \end{align}$$
# 
...
# 
# $$\displaystyle \varphi = \frac{\text{rate of emission}}{\text{rate of absorption}} =\frac{k_fS_1}{k_aG}=\frac{k_f}{k_f+k_S} \tag{5}$$
# 
...
# 
# $$\displaystyle \int\frac{1}{\alpha x^2+bx+c}dx=\frac{1}{\sqrt{b^2-4\alpha c}}\ln\left(\frac{2\alpha x+b-\sqrt{b^2-4\alpha c}}{2\alpha x+b+\sqrt{b^2-4\alpha c}} \right)+const, \qquad b^2\gt 4\alpha c \tag{5a}$$
# 
...
# 
# $$\displaystyle \log\left(\frac{a_0x_e+x(a_0-x_e)}{a_0(x_e-x)} \right)=k_1\frac{2a_0-x_e}{x_e}t \tag{5b}$$
# 
...
# 
# $$\displaystyle \Delta x=\Delta x_0e^{-(k_1+2k_2x_e)t}\tag{5c}$$
# 
...
# 
# $$\displaystyle \ln\left(\frac{a_0x_e+x(a_0-2x_e)}{a_0(x_e-x)} \right) = k_1\frac{2a_0(a_0-x_e)}{x_e}t\tag{5d}$$
# 
...
# 
# $$\displaystyle +\frac{1}{2}\frac{d[HI]}{dt} =\frac{1}{4}k_2(2[H_2]_0-[HI])(2[I_2]_0-[HI])-k_1[HI]^2\tag{5e}$$
# 
# If initially only HI is present then $ [HI]_0-[HI]=2[H_2]=2[I_2]$ then similarly calculating 
# 
# $$-\frac{1}{2}\frac{d[HI]}{dt}=k_1[HI]^2-\frac{k_2}{4}([HI]_0-[HI])^2\tag{5f}$$ 
# 
...
# 
# $$\displaystyle x=\frac{f}{f+2\sqrt{K_e}},\qquad f=\tanh(ak_2\sqrt{K_e}t)\tag{5g}$$
# 
# and starting with iodine and hydrogen only and integrating from $1\to x$, gives
# 
# $$\displaystyle x=\frac{1}{1+2f\sqrt{K_e}}\tag{5h}$$
# 
...
# 
# $$\displaystyle  \frac{dx}{dt}=-kx\left( \frac{x_s}{m}-\frac{x_0-x}{m}\right)  \tag{6}$$
# 
...
#  
# $$\displaystyle  \frac{dx}{dt}= kx(N-x) \tag{7} $$
# 
...
# 
# #### (viii) Mean free path and probability of obtaining a path of a given length.
# 
...
# 
# $$\displaystyle  Q=-kA\frac{d\theta}{dx} \tag{8}$$
# 
...
# 
# $$\displaystyle   J=-D\frac{dc}{dx}  \tag{9}$$
# 
...
# 
# $$\displaystyle   \frac{d\theta}{dt}=k(\theta_s-\theta) \tag{10}  $$
# 
