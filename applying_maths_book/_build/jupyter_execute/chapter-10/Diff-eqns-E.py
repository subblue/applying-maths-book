...
# first two terms in the expansion must then be examined. These are $\displaystyle 2a_2+\alpha a_0$ and $\displaystyle 6a_3+\alpha a_1 =0$ from which $a_2$ and $a_3$ can be found in terms of $a_0$ and $a_1$ and these then used as the starting points for the recursion formula. The series solution can be obtained using recursion. The first few terms are 
# 
