...
# 
# $$\displaystyle \int_{-L}^{L}\big( f(x)-g(x)\big)^2dx$$
# 
...
# 
# $$\displaystyle e^x = \frac{e^0}{0!} + \frac{x^1}{1!} + \frac{x^2}{2!} + \frac{x^3}{3!} \cdots=1 + x + \frac{x^2}{2!} + \frac{x^3}{3!} \cdots $$
# 
...
# 
# $$\displaystyle f(x,u)= p_0(x)+p_1(x)u + p_2(x)\frac{u^2}{2!}+\cdots = \sum\limits_{n=0}p_n(x)\frac{u^n}{n!}$$
# 
