...
# 
# $$\displaystyle 0.002  \times 6.022 \times 1023/(0.1 \times 10^9)^3 = 1.204 10^{−3}\quad\text{ molecules } \mathrm{nm^{−3}}$$
# 
...
# 
# $$\displaystyle \mathrm{A + B} \to \mathrm{2B}$$
# 
