...
# 
# Assume standard bond lengths d and sp3 tetrahedral bond angles θ. The bond vectors and axes are labelled in the diagram.
# 
...
# 
# (b) Calculate the remainder of the $\psi$angles, then modify the Maple code to calculate the $\phi$ angles.
# 
...
# The $x, y, z$ values are then elements 7, 8, and 9 of each row of the matrix. You will have to put the data into the folder from which you are starting a Python worksheet, otherwise the full path starting at C:\ will have to be used.
# 
# $$\displaystyle \Tiny\begin{array}\\
# &&&& x & y & z \\
# \hline
