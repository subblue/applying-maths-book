...
# 
# $$\displaystyle \vec u \times \vec v = |\vec u||\vec v|\sin(\theta)\;\vec n \tag{38}$$
# 
...
# 
# $$\displaystyle |\vec u \times \vec v|= |\vec u||\vec v|\sin(\theta)\tag{39}$$
# 
# The cross product is _anti-commutative_ , which means that
# 
# $$\displaystyle \vec u \times \vec v = -\vec v \times \vec u \tag{40}$$
# 
...
# v_x & v_y & v_z \end{bmatrix}\tag{41} \end{align}$$
# 
# 
...
# 
# $$\displaystyle d=|\vec d|=\frac{|\vec a\times\vec b|}{|\vec b|}\tag{42}$$
# 
...
# __________________
# 
# $$\displaystyle \vec n=\vec s\times\vec r =a\boldsymbol i+b\boldsymbol j+c\boldsymbol k \tag{43}$$
# 
...
# 
# $$\displaystyle \vec n\cdot (\vec X - \vec T) = 0 \tag{44}$$
# 
...
# 
# $$\displaystyle d=\frac{\vec n\cdot (\vec p-\vec T)}{\sqrt{\vec n\cdot\vec n}} \tag{45}$$
# 
...
# 
# $$\displaystyle d=\frac{a(p_x-t_x)+b(p_y-t_y)+c(p_x-t_x)}{\sqrt{a^2+b^2+c^2}}\tag{46}$$
# 
...
# 
# $$\displaystyle d_0=\frac{ap_x+bp_y+cp_x}{\sqrt{a^2+b^2+c^2}}\tag{47}$$
# 
...
# 
# $$\displaystyle d_0=\frac{abc}{\sqrt{(ab)^2+(bc)^2+(ac)^2}}=\frac{1}{\sqrt{(1/a)^2+(1/b)^2+(1/c)^2}}\tag{48}$$
# 
...
# 
# $$\displaystyle \vec A \times (\vec B \times \vec C) = (\vec A\cdot\vec C)\vec B - (\vec A\cdot\vec B)\vec C \tag{50}$$
# 
