...
# \qquad\vec w_1' = \vec v_r' \frac{m_2}{m_1+m_2}\qquad \vec w_2' = -\vec v_r' \frac{m_1}{m_1+m_2}$$
# 
...
# 
# $$\displaystyle \qquad\qquad\vec A \cdot \vec B=\begin{bmatrix} a & b & c \end{bmatrix}\begin{bmatrix} d\\e\\f \end{bmatrix} \qquad\qquad\qquad\qquad\qquad\qquad\text{(5)}$$
# 
