...
# 
# ![Drawing](vectors-fig38.png) ![Drawing](vectors-fig38-1FBB.png)
# 
...
# 
# ![Drawing](vectors-fig39.png) ![Drawing](vectors-fig40.png)
# 
...
# 
# $$\displaystyle \qquad \qquad \begin{align}\vec m &= \vec a \times \vec b = |\vec a||\vec b|\sin(\gamma)\vec u_m, \\   \vec n &= \vec b \times\vec c = |\vec b||\vec c|\sin(\alpha)\vec u_n \qquad \qquad\qquad \qquad\qquad \qquad \text{(51)}\end{align}$$
# 
# 
...
# 
# $$\vec m\cdot \vec n = (\vec a \times \vec b)\cdot(\vec b \times \vec c)\tag{52}$$
# 
...
# 
# $$\vec m\cdot\vec n = | \vec c || \vec b |^2| \vec a |\sin(\alpha)\sin(\gamma )\vec u_m\cdot\vec u_n  = |\vec  c || \vec b |^2| \vec a |\sin(\alpha)\sin(\gamma )\cos(\psi)\tag{53}$$
# 
...
# 
# $$\displaystyle \cos(\psi)=\frac{\vec m\cdot\vec n}{|\vec m||\vec n|}= \frac{\vec m\cdot\vec n}{\sqrt{\vec m\cdot\vec m}\sqrt{\vec n\cdot\vec n}}\tag{54}$$
# 
...
# 
# The conformation of the sugar is often represented in terms of its pseudo-rotation angle $P$, which is the torsion (dihedral) angle $ v_2 = C'_1C'_2 - C'_3C'_4$. The configurations are shown in the next diagram, figure 44, showing very approximate angles; the configuration with $0 < P < 90$ degrees are $C'_3$ endo and $-90 < P < 0$ degrees are $C'_2$ endo. Configurations on the right half of the diagram, $C'_3$ endo and $C'_2$ exo, are called north ($N$), the others are south ($S$).
# 
# ![Drawing](vectors-fig43-44.png)
# 
# Left Figure 43  A $C3'$ endo sugar. The $C_4'-O_4'-C_1'$ are in one plane, the $C_3'$ above the plane on the side of $C_5'$ and $C_2'$ below the plane. The cartoon structures on the right show this also. Right figure 44. Pseudo rotation angles.
# _______
# 
# ### 21.1 Pseudo-rotation angles
# 
# The torsion angles for the phosphate and sugar in the DNA are shown below, Figure 45; the torsion angle $\gamma$ is calculated with atoms $O'_5C'_5-C'_4C'_3$, the pucker or pseudo-rotation angle $v_2 = C'_1C'_2 - C'_3C'_4$. The angle $\chi$ is calculated with atoms $O'_4C'_1-N_9C_4$ for purines, 
# 
...
# 
# ![Drawing](vectors-pseudo-rot.png) ![Drawing](vectors-fig45.png)
# 
