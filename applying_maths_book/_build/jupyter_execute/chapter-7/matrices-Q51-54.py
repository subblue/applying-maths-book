...
# **(a)** Calculate the time profile of species A, B and C for the scheme
# 
...
# 
# **(b)** Use the markov chain method to calculate the populations in fig 55b.
# 
# **Strategy:** (a) Write down the rate equations and then translate them into the Master Equation matrix form. Use python to do the integration by the matrix method outlined in the text, Algorithm 7.6. (b) Base you calculation on the example in the text. Use similar rate constants etc. Vary the staring concentrations to see what happens.
# 
