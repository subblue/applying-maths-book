...
# 
# $$\displaystyle I_p=I_{cm}+Md^2 \qquad\tag{69}$$
# 
...
# 
# $$\displaystyle I_\alpha= \sum_i m_ir_i^2 \qquad\tag{70}$$
# 
...
# 
# $$\displaystyle q_{cm}=\frac{\sum_im_iq_i}{\sum_i m_i}=\frac{\sum_im_iq_i}{M} \qquad\tag{71}$$
# 
...
# therefore
# 
# $$\displaystyle I_z=I_x+I_y \qquad\tag{72}$$
# 
...
# 
# $$\displaystyle I_\alpha= Mk^2 \qquad\tag{73}$$
# 
