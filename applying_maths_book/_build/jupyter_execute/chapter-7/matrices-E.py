...
# 
# The gap is just that: an air gap or a piece of glass of length $d$ with refractive index $n$. The refractive index of air is practically 1, and can be taken to be 1 for the purpose of almost all calculations. The refractive index of different glasses depends on their composition but $\approx 1.52$ is a typical value for crown glass. Quartz has a smaller value of $\approx 1.48$ and glasses containing rare earth elements, values of $\approx 1.8$. Water has a refractive index of $1.33$ at room temperature, and liquids with more polarizable atoms such as CCl$_4$4 have higher values $\approx 1.6$. The reflection matrix shown is for a positive, concave, or focusing mirror with radius of curvature $-r$. A positive radius of curvature $+r$, by convention, applies to a _negative_ mirror, which is defined when the ray approaches from the left and meets a convex mirror surface. This is the convention shown in figure 37, where the surface is convex to the incoming ray starting at point Q. The radius $+r$ is shown as the line SR, see also  figure 43. The focal length $f$ of a mirror is half the radius of curvature and it is often easier to use this rather than $r$.
# 
...
# 
# $$\displaystyle n_1\theta_1+n_1y_1/r =n_2\theta_2+n_2y_1/r \qquad \text{or} \qquad y_1\frac{n_1-n_2}{r}=n_2\theta_2-n_1\theta_1$$
# 
# 
