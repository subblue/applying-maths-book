...
# 
# **Summary:**  If $n$ and $m$ are the numbers $1$ to $6$ (the sample space) on a die, then the probability of throwing;
# 
...
# _____
# #### v(iii) Conditional probability. Throwing coins
...
# 
# $$\displaystyle \begin{align} (p+q)^4&= \sum_{m=0}^n\frac{n!}{m!(n-m)!}q^mp^{n-m}\\ &= \frac{4!}{0!4!}q^0p^{4}+\frac{4!}{1!3!}q^1p^{3}+\frac{4!}{2!2!}q^2p^{2}+\frac{4!}{3!1!}q^3p^{1}+\frac{4!}{4!0!}q^4p^{0}\\&=p^4+4qp^3+6q^2p^2+4q^3p+q^4\end{align}$$
# 
...
# 
# $$\displaystyle P(7,0,1/2)=\frac{7!}{0!(7-0)!}\left( \frac{1}{2}\right)^0 \left(1- \frac{1}{2}\right)^{7-0}=\frac{1}{128}$$
# 
...
# Integrating gives,
# 
# $$\displaystyle S_2-S_1=R\ln\left(\frac{V_2}{V_1}\right)$$
# 
...
# 
# Figure 20bb The Poisson distribution
# ________
# 
...
# 
# Figure 20d. Calulated spectrum for CO.The size of the absorption lines follows the Poisson distribution. 
# 
