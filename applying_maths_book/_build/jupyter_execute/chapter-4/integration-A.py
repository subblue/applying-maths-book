...
# 
# $\displaystyle \int  \frac{1}{a^{2} x^{2} + b^{2}} \;dx =  \frac{1}{ab}\tan^{-1}\left(\frac{ax}{b}\right) $
# 
# $\displaystyle \int  \frac{1}{a^{2} x^{2} - b^{2}} \;dx =  \frac{1}{2ab}\ln\left(\frac{ax-b}{ax+b}\right) $
# 
