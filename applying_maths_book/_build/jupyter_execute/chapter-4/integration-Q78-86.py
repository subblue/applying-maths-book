...
# 
# $$\displaystyle S=k_B\left( \frac{\partial \ln(Q)}{\partial T} \right)_V$$
# 
...
# 
# $$\displaystyle \langle z\rangle  = \alpha \int\varphi_1^*z\varphi_2d\tau$$
# 
...
# 
# $$\displaystyle P(z, t)dz =\int\psi^*(\tau,t)\psi(\tau,t)d\tau dz$$
# 
# where $a$ and $b$  are constants that normalize $\psi$ ; therefore $a^2 + b^2 = 1$. The integral $P$ can be evaluated using cylindrical coordinates, which then becomes the _double_ integral 
# 
...
# 
# $$\displaystyle \varphi_j(t)=\varphi_je^{-iE_jt/\hbar}$$
# 
...
# 
# $$\displaystyle \psi=\frac{\sqrt{3}}{2}\varphi_{1s}e^{-iE_{1s}t/\hbar} +\frac{1}{2}\varphi_{2s}e^{-iE_{2s}t/\hbar}$$
# 
