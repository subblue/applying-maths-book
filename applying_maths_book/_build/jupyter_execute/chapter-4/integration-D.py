...
# 
# $$\displaystyle \langle q\rangle= \frac{\sum\limits_{i=1}^N q_iP(q_i)}{\sum\limits_{i=1}^N P(q_i)} \qquad\tag{25}$$
# 
...
# 
# $$\displaystyle \sigma ^2 =\langle q^2\rangle -\langle q\rangle^2 =  \langle q^2\rangle- \mu \qquad\tag{26}$$
# 
...
# 
# $$\displaystyle \langle q^n\rangle= \frac{\sum\limits_{i=1}^N q_i^nP(q_i)}{\sum\limits_{i=1}^N P(q_i)} \qquad\tag{27}$$
# 
# ### **(i) Invert sugar**
# 
...
# 
# $$\displaystyle \langle x\rangle =\frac{\int xP(x)dx}{\int P(x)dx}    \qquad\tag{28}$$
# 
...
# 
# $$\displaystyle \langle s\rangle = \frac{\int sw(s)}{\int w(s) }=\frac{M_s}{A}  \qquad\tag{30}$$
# 
...
# 
# $$\displaystyle M_x=\frac{1}{2}\int_a^b f(x)^2-g(x)^2 dx  \qquad\tag{31}$$
# 
# In the special case that the lower curve is the x-axis, then the function $g(x) =0$ and
# 
# $$\displaystyle M_x=\frac{1}{2}\int_a^b f(x)^2 dx = \frac{1}{2}\int_a^b y^2 dx\qquad\tag{32}$$
# 
...
# which produces 
# 
# $$\displaystyle M_y= \int_a^b xf(x)-xg(x) dx\qquad\tag{33}$$
# 
# and when $g$ is the x-axis,
# 
# $$\displaystyle M_y= \int_a^b xf(x) dx=\int_a^b xy dx \qquad\tag{34}$$
# 
# The area $\displaystyle A=\int_a^bf(x)-g(x)dx $ and the centroids are therefore
# 
# $$\displaystyle \langle y\rangle =\frac{M_x}{A}, \qquad \langle x\rangle =\frac{M_y}{A}  \qquad\tag{35}$$
# 
...
# 
# $$\displaystyle P(n)= p\frac{(np)^{(N-1)}}{(N-1)!}e^{-np} \qquad\tag{35a}$$
# 
...
# 
# $$\displaystyle  \langle n\rangle =  \frac{N}{p}\qquad\tag{35b}$$
# 
...
# 
# $$\displaystyle \sigma_n^2=\displaystyle \frac{N(N+1)}{p^2}-\frac{N^2}{p^2}=\frac{N}{p^2}\qquad\tag{35c}$$ 
# 
...
# 
# $$\displaystyle \langle f(x) \rangle = \frac{\int f(x)P(x)dx}{\int P(x)dx}  \qquad\tag{36}$$
# 
...
# 
# $$\displaystyle \langle x_k\rangle = \int_{-\infty}^\infty \psi_k^*\,x\,\psi_k dx \equiv \langle k|x|k\rangle \qquad\tag{37}$$
# 
...
# 
# $$\displaystyle \langle Q_{n,m}\rangle =\frac{ \int\psi_n^*\,Q\,\psi_m dx}{ \int \psi_n^*\psi_m dx} \qquad\tag{38}$$
# 
...
# 
# $$\displaystyle \langle Q_{n,m}\rangle = \int\psi_n^*\,Q\,\psi_m dx \qquad\tag{39}$$
# 
...
# 
# $$\displaystyle \langle m_k\rangle = \int x^kP(x)dx  \qquad\tag{41}$$
# 
# thus 
# 
# $$\displaystyle m_1 \equiv \langle m_1\rangle =\int xP(x)dx , \qquad  m_2 \equiv \langle m_2\rangle =\int x^2P(x)dx  \qquad\tag{42}$$
# 
# The _variance_ of a distribution is 
# 
# $$\displaystyle \sigma_x^2 = \langle x^2\rangle - \langle x\rangle ^2 = \int (x-\langle x\rangle )^2P(x)dx  \qquad\tag{43}$$
# 
