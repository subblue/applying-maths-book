...
# 
# $\quad$**(i)** Start by trying $u=y$ and $dv=\cos(y)dy$
# 
# $\quad$**(ii)**  To find $uv$, integrate $v=\cos(y)dy$ to $v=\sin(y)$ and then multiply this by $u\equiv y$.
# 
# $\quad$**(iii)**  Form the $vdu$ integral by differentiating $u$ giving $du\equiv dy=1 $ and multiply by $v=\sin(y)$ to give $\int vdu =\int \sin( y)dy$.
# 
# $\quad$**(iv)** ) Combining these terms gives 
# 
